# See http://garmoncheg.blogspot.com/2014/05/implementing-multiple-radio-select.html
# TODO : Radio Select 방식에 Other 옵션을 추가한 형식인데, 레거시버전 기준으로 작성된 코드라 좀 더 다듬어야 합니다.
